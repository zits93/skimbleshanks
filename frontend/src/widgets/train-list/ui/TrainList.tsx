            ...
            <div className="results-panel">
                <div className="glass" style={{
                    ...
                    <div style={{textAlign: 'center'}}>
                        <h3 style={{color: 'var(--primary)', fontSize: '1.4rem', marginBottom: '0.5rem', fontFamily: 'Outfit, sans-serif'}}>열차 정보를 불러오는 중</h3>
                        <p style={{fontSize: '0.95rem', color: 'var(--text-muted)', opacity: 0.8}}>최적의 노선을 찾고 있습니다. 잠시만 기다려주세요...</p>
                    </div>
                </div>
            </div>
        );
